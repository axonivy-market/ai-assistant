...
public class AiAssistantWebTest {
  ...
  @Test
  public void checkUIOverall(WebAppFixture fixture) throws InterruptedException {
    fixture.login("Developer", "Developer");
    System.out.println(EngineUrl.createProcessUrl("/ai-assistant-demo/1919CEDEF7828B77/startComplexDemo.ivp"));
    System.out.println(EngineUrl.createProcessUrl("/ai-assistant/19198CAD6D9F2F9E/AssistantDashboard.ivp"));
    ...
    // TODO fix this test after updating production code
